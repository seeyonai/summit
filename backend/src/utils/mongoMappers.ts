...
export function recordingDocumentToResponse(recordingDoc: RecordingDocument): RecordingResponse {
  return {
    ...
    transcriptionStatus: recordingDoc.transcriptionStatus,
    transcriptionProgressSeconds: recordingDoc.transcriptionProgressSeconds,
    transcriptionProgressTotalSeconds: recordingDoc.transcriptionProgressTotalSeconds,
    alignmentStatus: recordingDoc.alignmentStatus,
    alignmentProgressSeconds: recordingDoc.alignmentProgressSeconds,
    alignmentProgressTotalSeconds: recordingDoc.alignmentProgressTotalSeconds,
    transcription: recordingDoc.transcription,
    transcriptionChunks: recordingDoc.transcriptionChunks,
