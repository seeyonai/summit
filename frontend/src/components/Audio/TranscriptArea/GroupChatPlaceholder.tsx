...
const GroupChatPlaceholder: React.FC = () => {
  return (
    <Card className="bg-gradient-to-r from-violet-900/10 to-purple-900/10 border-violet-500/20 backdrop-blur-sm shadow-xl shadow-violet-500/5">
      <CardContent className="p-6">
        ...
        <div className="text-center py-8">
          <MessageSquare className="w-12 h-12 text-violet-400 mx-auto mb-3 opacity-50" />
