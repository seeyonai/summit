      ...
      <div className="space-y-4">
        {meeting.finalTranscript ? (
          <div className="bg-success/5 border border-success/20 rounded-lg p-6">
            <div className="flex items-center justify-between mb-4">
              <h4 className="text-md font-medium text-success">AI优化会议纪要</h4>
              <div className="flex items-center space-x-2">
                <svg className="h-5 w-5 text-success" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
                <span className="text-sm text-success">已优化</span>
              </div>
            </div>
            <div className="prose prose-sm max-w-none">
              <div className="text-success whitespace-pre-wrap">{meeting.finalTranscript}</div>
            </div>
          </div>
        ) : hasTranscripts ? (
          <div className="bg-warning/5 border border-warning/20 rounded-lg p-6">
            <div className="flex items-center justify-between mb-4">
              <h4 className="text-md font-medium text-warning">原始转录内容</h4>
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-warning">待优化</span>
              </div>
            </div>
          ...
          <div className="bg-muted border border-border rounded-lg p-8 text-center">
            ...
            <h4 className="text-lg font-medium text-muted-foreground mb-2">暂无会议纪要</h4>
